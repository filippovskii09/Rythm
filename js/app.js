(() => {
    ...
    const btn = document.querySelectorAll(".store-theme__button");
    const firstList = document.querySelector(".dnfirst");
    const secondList = document.querySelector(".dnsecond");
    btn[0].addEventListener("click", (function() {
        firstList.classList.remove("dnfirst");
        firstList.classList.add("db-first");
    }));
    btn[1].addEventListener("click", (function() {
        secondList.classList.remove("dnsecond");
        secondList.classList.add("db-second");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
